                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a class="status pending"
                                href="index.php?quanly=capnhaptrangthaichosinhvienqlsv&iddg=<?php echo $row['id_dg']; ?>">Cập nhập </a></td>
                                <?php
                        }
                        ?>
                        <?php 
                        ...
                        <td> <a class="status cancelled"
                                href="index.php?quanly=capnhapmaudonqlsv&iddg=<?php echo $row['id_dg']; ?>">Tiếp nhận đơn </a></td>
                        <?php
                        }else  if($row['tinhtrang'] != 'Đã hoàn thành đơn' && $row['tinhtrang'] != 'Đã xác nhận' ){?>
                         <a class="status cancelled"
                                href="index.php?quanly=xacnhanhoanthanhqlsv&iddg=<?php echo $row['id_dg']; ?>">Xác nhận hoàn thành </a></td>
                        <?php 
                        }
                            ?>
                    </tr>
