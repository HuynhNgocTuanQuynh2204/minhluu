...
$noidung = $_POST['noidung'];
 if(isset($_POST['capnhap'])){
    ...
    echo '<script type="text/javascript">alert("Cập nhập form thành công"); window.location.href = "index.php?quanly=danhsachformguisvkinhte"; </script>';
   ...
   $query = mysqli_query($mysqli,$sql);
   echo '<script type="text/javascript">alert("Đã tiếp nhận đơn");    window.location.href = "index.php?quanly=danhsachformguisvkinhte"; </script>';
 }
