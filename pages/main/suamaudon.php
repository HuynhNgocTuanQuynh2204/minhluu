...
?>
    <div class="container" style="margin-left: 100p;">
        <a href="index.php?quanly=danhsachmaudon" Class="btn btn-success" style="margin-left: 500px;">Danh sách các loại
            đơn xin</a>
        <div class="row d-flex justify-content-right align-items-right">
            <div class="col-5">
                <h1 class="mb-5">Thêm các loại đơn xin</h1>
                <form action="index.php?quanly=xulythemmaudonxin&idmd=<?php echo $row['id_md'] ;?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label class="form-label">Tên mẫu đơn</label>
                        <input name="name" type="text" class="form-control" value="<?php echo $row['tenmd'] ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="tomtat" rows="5" style="resize: none;"
                            name="huongdan"><?php echo $row['huongdan'] ?></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" name="suamaudon">Sửa mẫu đơn</button>
                </form>
            </div>
