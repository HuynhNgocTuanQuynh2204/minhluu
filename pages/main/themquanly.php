<main class="main container" id="main" >
    ...
    <a href="index.php?quanly=danhsachquanly" Class="btn btn-success" style="margin-left: 500px;">Danh sách quản lí</a>
        <div class="row d-flex justify-content-right align-items-right">
            <div class="col-5">
                <h1 class="mb-5">Thêm quản lí</h1>
                <form action="index.php?quanly=xulythemquanly" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="quyenhan" type="text" class="form-control" required>
                    </div>
