                    ...
                    ?>
                            <tr>
                                ...
                                <?php if ($row['tinhtrang'] != 'Đã xác nhận') { ?>
                                    <td><a class="status pending" href="index.php?quanly=caonhapformsvsupham&idform=<?php echo $row['id_form']; ?>">Cập nhật</a></td>
                                <?php } ?>
                                <?php if ($row['tinhtrang'] == 'Đã tiếp nhận đơn và gửi về đơn vị có liên quan') { ?>
                                    <td><a class="status cancelled" href="index.php?quanly=xacnhanformsvsupham&idform=<?php echo $row['id_form']; ?>">Tiếp nhận đơn</a></td>
                                <?php } elseif ($row['tinhtrang'] != 'Đã hoàn thành đơn' && $row['tinhtrang'] != 'Đã xác nhận') { ?>
                                    <td><a class="status cancelled" href="index.php?quanly=xacnhanhoanthanhformsupham&idform=<?php echo $row['id_form']; ?>">Xác nhận hoàn thành</a></td>
                                <?php } ?>
                            </tr>
                    <?php
                        }
