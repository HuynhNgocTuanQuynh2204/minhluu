                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a class="status pending"
                                href="index.php?quanly=capnhaptrangthaichosinhviencntt&iddg=<?php echo $row['id_dg']; ?>">Cập nhập </a></td>
                                <?php
                        }
                        ?>
                        <?php 
                        ...
                        <td> <a class="status cancelled"
                                href="index.php?quanly=capnhapmaudon&iddg=<?php echo $row['id_dg']; ?>">Tiếp nhận đơn </a></td>
                        <?php
                        }else{?>
                         <a class="status cancelled"
                                href="index.php?quanly=xacnhanhoanthanh&iddg=<?php echo $row['id_dg']; ?>">Xác nhận hoàn thành </a></td>
                        <?php 
                        }
                            ?>
                    </tr>
