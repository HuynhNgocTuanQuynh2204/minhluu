                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a class="status pending"
                                href="index.php?quanly=caonhapformsvnongnghiep&idform=<?php echo $row['id_form']; ?>">Cập nhập </a></td>
                                <?php
                        }
                        ?>
                                <?php 
                        ...
                        <td> <a class="status cancelled"
                                href="index.php?quanly=xacnhanformsvnongnghiep&idform=<?php echo $row['id_form']; ?>">Tiếp nhận đơn </a></td>
                        <?php
                        }else  if($row['tinhtrang'] != 'Đã hoàn thành đơn' && $row['tinhtrang'] != 'Đã xác nhận' ){?>
                         <a class="status cancelled"
                                href="index.php?quanly=xacnhanhoanthanhformnongnghiep&idform=<?php echo $row['id_form']; ?>">Xác nhận hoàn thành </a></td>
                        <?php 
                        }
                            ?>
                            </tr>
