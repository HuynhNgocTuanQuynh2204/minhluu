...
<main class="main container" id="main" >
    <div class="container" style="margin-left: 100p;">
        <div class="row d-flex justify-content-right align-items-right">
            <div class="col-5">
                <h1 class="mb-5">Cập nhập trạng thái form</h1>
                <form action="index.php?quanly=xacnhanformsvnongnghiep&idform=<?php echo $row['id_form'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
